...
namespace XR.Interaction.Toolkit.Hand.Utilities.InputSystemUtilities
{
    ...
    public struct HandTrackedXRControllerState : IInputStateTypeInfo
    {
        /// <summary>
        ...
        /// </summary>
        [InputControl(name = nameof(HandTrackedXRController.primaryButton), usage = "PrimaryButton", layout = "Button", bit = (uint)ControllerButton.PrimaryButton, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.primaryTouch), usage = "PrimaryTouch", layout = "Button", bit = (uint)ControllerButton.PrimaryTouch, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.secondaryButton), usage = "SecondaryButton", layout = "Button", bit = (uint)ControllerButton.SecondaryButton, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.secondaryTouch), usage = "SecondaryTouch", layout = "Button", bit = (uint)ControllerButton.SecondaryTouch, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.gripButton), usage = "GripButton", layout = "Button", bit = (uint)ControllerButton.GripButton, offset = 24, alias = "gripPressed")]
        [InputControl(name = nameof(HandTrackedXRController.triggerButton), usage = "TriggerButton", layout = "Button", bit = (uint)ControllerButton.TriggerButton, offset = 24, alias = "triggerPressed")]
        [InputControl(name = nameof(HandTrackedXRController.menuButton), usage = "MenuButton", layout = "Button", bit = (uint)ControllerButton.MenuButton, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.primary2DAxisClick), usage = "Primary2DAxisClick", layout = "Button", bit = (uint)ControllerButton.Primary2DAxisClick, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.primary2DAxisTouch), usage = "Primary2DAxisTouch", layout = "Button", bit = (uint)ControllerButton.Primary2DAxisTouch, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.secondary2DAxisClick), usage = "Secondary2DAxisClick", layout = "Button", bit = (uint)ControllerButton.Secondary2DAxisClick, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.secondary2DAxisTouch), usage = "Secondary2DAxisTouch", layout = "Button", bit = (uint)ControllerButton.Secondary2DAxisTouch, offset = 24)]
        [InputControl(name = nameof(HandTrackedXRController.userPresence), usage = "UserPresence", layout = "Button", bit = (uint)ControllerButton.UserPresence, offset = 24)]
        [FieldOffset(24)]
        ...
        public HandTrackedXRControllerState WithButton(ControllerButton button, bool state = true)
        {
        ...
        public void SetTriggerAndButton(float value)
        {
            trigger = Mathf.Clamp01(value);
            WithButton(ControllerButton.TriggerButton, trigger > 0.65f);
        }

        public void SetGripAndButton(float value)
        {
            grip = Mathf.Clamp01(value);
            WithButton(ControllerButton.GripButton, grip > 0.65f);
        }
